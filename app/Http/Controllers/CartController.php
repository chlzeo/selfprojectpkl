...
class CartController extends Controller
{
        ...
        try {
            ...
            if ($cartItem) {
                ...
                $cart->items()->create([
                    ...
                    // 'discount_at_add' => $product->discount, // Remove discount
                ]);
            }
            DB::commit();
    ...
    public function showCart()
    {
        ...
        return view('home.cart.show', compact('cartItems', 'subtotal', 'total'));
    }
    ...
    public function checkout()
    {
        ...
        return view('home.checkout.index', compact('cartItems', 'subtotal', 'total', 'user', 'defaultAddress'));
    }
    ...
    public function processCheckout(Request $request)
    {
        ...
        try {
            ...
            foreach ($cartItems as $item) {
                ...
                $subtotal += ($itemPrice * $itemQuantity);
                $finalTotalAmount += ($itemPrice * $itemQuantity);
            }
            ...
            foreach ($cartItems as $item) {
                ...
                // $orderItem->discount_per_unit = $item->discount_at_add; // Remove discount
                $orderItem->save();
