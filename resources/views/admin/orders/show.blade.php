        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <p><strong>Status:</strong> <span class="badge {{ $order->status == 'pending' ? 'bg-warning' : ($order->status == 'processing' ? 'bg-info' : ($order->status == 'completed' ? 'bg-success' : 'bg-danger')) }}">{{ ucfirst($order->status) }}</span></p>
                    <p><strong>Status Pembayaran:</strong> <span class="badge {{ $order->payment_status == 'pending' ? 'bg-warning' : ($order->payment_status == 'paid' ? 'bg-success' : 'bg-danger') }}">{{ ucfirst($order->payment_status) }}</span></p>
