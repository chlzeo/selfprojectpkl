...
@section('content')
    ...
    <header class="text-white text-center py-4"
        ...
        <div class="container">
            ...
            <p>Produk dan Koleksi2 andalan kami yang mungkin anda suka</p>
        </div>
    </header>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        @else
                                            <div class="img-fluid d-flex align-items-center justify-content-center text-white-50"
                                                style=" height: 100%; background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(253, 13, 13, 0.7)), url('https://wallpapercave.com/wp/wp10992174.png'); background-size: cover; background-position: center;">
                                                Chlzengine Image
                                            </div>
                                        @endif
                                    </div>
