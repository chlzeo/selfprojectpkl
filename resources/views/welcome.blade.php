...
<body>
    <!-- Navbar Start -->
    <nav class="navbar navbar-expand-lg navbar-dark" style="background:#111; border-bottom:4px solid #e00;">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold d-flex align-items-center" href="#" style="color:#e00;">
                <img src="{{asset('assets/transport.png')}}" alt="Logo" width="36" height="36" class="me-2"
                    style="background:#111; border-radius:50%;">
                CHLZENGINE
            </a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarDealer"
                aria-controls="navbarDealer" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarDealer">
                <ul class="navbar-nav ms-3 mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="./chlzengine.html"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./inventory.html" style="color:#fff;">Inventory</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" style="color:#fff;">Parts</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./tentang.html" style="color:#fff;">About</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="ms-auto">
                    <a href="{{ route('login') }}" class="btn btn-danger" style="background:#e00; border:none; font-weight:bold;">
                        Login
                    </a>
                </div>
            </div>
    ...
    <div class="position-relative" style="height: 70vh; min-height: 400px; background: #000;">
        <img src="{{asset('assets/ferari.jpg')}}" alt="Chlzengineinv" class="position-absolute top-50 end-0 translate-middle-y"
            ...
            <div class="col-lg-6">
                <div id="aboutCarousel" class="carousel slide shadow rounded" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="{{asset('assets/YAMAHA-R1M-MONSTER-ENERGY-GP-2019-3.jpg')}}" class="d-block w-100 rounded"
                                alt="Showroom 3" style="object-fit:cover; height:300px;">
                        </div>
                    </div>
    ...
    <!-- Footer Start -->
    <footer class="mt-5" style="background:#e00; color:#fff; border-top:4px solid #111;">
        <div class="container py-4">
            <div class="row align-items-center">
                <div class="col-md-6 mb-2 mb-md-0">
                    <span class="fw-bold">© 2024 CHLZENGINE</span> &nbsp;|&nbsp; All rights reserved.
                </div>
                <div class="col-md-6 text-md-end">
                    <a href="#" class="text-white me-3" style="text-decoration:underline;">Privacy Policy</a>
                    <a href="#" class="text-white me-3" style="text-decoration:underline;">Terms</a>
                    <a href="./contact.html" class="text-white" style="text-decoration:underline;">Contact</a>
                </div>
            </div>
        </div>
    </footer>
